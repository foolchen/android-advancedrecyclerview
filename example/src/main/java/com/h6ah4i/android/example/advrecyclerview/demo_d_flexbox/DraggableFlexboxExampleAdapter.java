...
class DraggableFlexboxExampleAdapter
        extends RecyclerView.Adapter<DraggableFlexboxExampleAdapter.BaseViewHolder>
        implements DraggableItemAdapter<DraggableFlexboxExampleAdapter.BaseViewHolder> {
    ...
    public DraggableFlexboxExampleAdapter(AbstractDataProvider dataProvider) {
    ...
    public void onBindViewHolder(@NonNull BaseViewHolder holder, int position) {
        ...
        int width = (int) ((getItemId(position) % 3 + 1) * 300);
